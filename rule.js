function(user, context, callback) {
  ...
  var qs = querystring; // alias for querystring
  ...
  var tokenutil = (function() {
    ...
    var generateSignedUrl = function(container, blob, accessPolicy, headers) {
      var blobService = new BlobService(configuration.AZURE_STORAGE_ACCOUNT_NAME, configuration.AZURE_STORAGE_ACCOUNT_KEY);
  ...
  if (accessPolicy.AccessPolicy.Permissions) {
    var url = tokenutil.generateSignedUrl(blobContainer, blobName, accessPolicy);
